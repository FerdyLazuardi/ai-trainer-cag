...
class AgentLog(Base):
    ...
    # User & branch hierarchy metadata (from Spreadsheet + Moodle JWT)
    username: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    full_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    position: Mapped[str | None] = mapped_column(String(128), nullable=True)
    point: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    area: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    regional: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    pulau: Mapped[str | None] = mapped_column(String(64), nullable=True)
